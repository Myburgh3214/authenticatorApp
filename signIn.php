...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      if($row['role'] == "customer"){
        ...
        WHERE  book_name = '$searchDb' OR book_name LIKE '$searchDb%' OR year = '$searchDb' OR year LIKE '$searchDb%' OR  books.genre = '$searchDb' OR books.genre LIKE '$searchDb%' OR author_name = '$searchDb' LIKE '$searchDb' ";
